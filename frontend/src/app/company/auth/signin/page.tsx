      ...
      <main className="flex-1 flex flex-col items-center justify-center py-12 px-4 relative overflow-hidden">
        ...
        <div className="w-full max-w-[480px] bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-8 md:p-10 shadow-2xl transition-all relative z-10">
          ...
          <div className="space-y-6">
            <button className="w-full flex items-center justify-center gap-4 px-6 py-4 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 rounded-xl font-bold hover:bg-slate-50 dark:hover:bg-slate-700 transition-all group active:scale-[0.98] shadow-sm">
            ...
            <div className="relative flex items-center py-2">
              ...
              <span className="flex-shrink mx-4 text-slate-400 text-[10px] font-black uppercase tracking-widest italic">or with organization email</span>
              <div className="flex-grow border-t border-slate-200 dark:border-slate-800"></div>
            </div>
